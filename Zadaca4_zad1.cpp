...
public:
    ...
    bool DaLiJeUnutra(Tacka t) const
    {
        ...
        if (Orijentacija(t1, t2, t) == 0 || Orijentacija(t1, t3, t) == 0 || Orijentacija(t2, t3, t) == 0)
            return false;
    ...
    void Skaliraj(Tacka centar, double k)
    {
        ...
        int indeks = 0;
        if (std::fabs(centar.first - t1.first) < 0.00001 && std::fabs(centar.second - t1.second) < 0.00001)
            indeks = 1;
        else if (std::fabs(centar.first - t2.first) < 0.00001 && std::fabs(centar.second - t2.second) < 0.00001)
            indeks = 2;
        else if (std::fabs(centar.first - t3.first) < 0.00001 && std::fabs(centar.second - t3.second) < 0.00001)
            indeks = 3;
...
bool DaLiSuIdenticni(Trougao t1, Trougao t2)
{
    ...
    if (std::fabs(a1.first - b1.first) < 0.0001 && std::fabs(a1.second - b1.second) < 0.0001)
    {
        ...
        {
            if (std::fabs(a3.first - b3.first) < 0.0001 && std::fabs(a3.second - b3.second) < 0.0001)
                return true;
        }
        else if (std::fabs(a2.first - b3.first) < 0.0001 && std::fabs(a2.second - b3.second) < 0.0001)
        {
            if (std::fabs(a3.first - b2.first) < 0.0001 && std::fabs(a3.second - b2.second) < 0.0001)
                return true;
        }
    }
    ...
    else if (std::fabs(a1.first - b3.first) < 0.0001 && std::fabs(a1.second - b3.second) < 0.0001)
    {
        ...
        {
            if (std::fabs(a3.first - b1.first) < 0.0001 && std::fabs(a3.second - b1.second) < 0.0001)
                return true;
        }
    }
...
bool DaLiSuPodudarni(Trougao t1, Trougao t2)
{
    ...
    for (int i = 0; i < 3; i++)
    {
        if (std::fabs(prvi.at(i) - drugi.at(i)) > 0.0001)
            return false;
    }
...
bool DaLiSuSlicni(Trougao t1, Trougao t2)
{
    ...
    if (std::fabs(odnos1 - odnos2) > 0.0001 || std::fabs(odnos1 - odnos3) > 0.0001 || std::fabs(odnos2 - odnos3) > 0.0001)
        return false;
