...
int main()
{
    ...
    if (ulazni_tok.bad())
        std::cout << "Datoteka je vjerovatno oštećena!\n";
    else if (neispravni_podaci == true && !ulazni_tok.eof())
        std::cout << "Datoteka sadrži neočekivane podatke!\n";
